...
const features: IFeature[] = [
	{
		icon: <ChatCircle className="w-12 h-12 mx-auto my-4 text-light" />,
	...
	{
		icon: <Users className="w-12 h-12 mx-auto my-4 text-light" />,
		title: "Get Involved",
		caption:
	...
	{
		icon: <Money className="w-12 h-12 mx-auto my-4 text-light" />,
		title: "Donate",
		caption:
...
export default function Contribute() {
	return (
		<div
			id="contribute"
			className="flex flex-col p-3 gap-4 bg-gradient-to-b from-primary/40"
		>
			<h2
