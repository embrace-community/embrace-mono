...
export function App({ app }: Props) {
	return (
		<section className="md:justify-left flex max-w-[800px] flex-col items-center gap-2 rounded-xl border-[1px] border-light p-2 md:h-60 md:flex-row md:gap-6 md:p-6">
