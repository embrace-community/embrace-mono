...
const features: IFeature[] = [
	{
		icon: <UsersThree className="w-12 h-12 mx-auto my-4 text-light" />,
		title: "Community First",
		caption: "Community is our greatest resource.\n It's what makes us Human.",
		description:
			"As technology continues to proliferate society we need to prioritise the health of our communities above all."
	},
	{
		icon: <Heart className="w-12 h-12 mx-auto my-4 text-light" />,
		title: "Non-Profit",
		caption: "We are not motivated by profit;\n we are in service to community",
		description:
	...
	{
		icon: <Globe className="w-12 h-12 mx-auto my-4 text-light" />,
		title: "Open Source",
		caption:
...
export default function Mission() {
	return (
		<div id="mission" className="flex flex-col p-3 gap-4">
			<h2
			...
			<div className="flex flex-col gap-4 lg:flex-row lg:m-4">
